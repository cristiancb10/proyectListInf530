...
//se declara un objeto de la clase Task()
    $task = new Task();
//recoger los datos actualizados del formulario de update de tareas
    $task -> description = $_POST['description'];
    $task -> due_day = $_POST['due_day'];
...
//primero extrae de la URL con GET
elseif($_SERVER["REQUEST_METHOD"] == 'GET'){
//se declara una variable $id_user donde se guardara el valor de $_GET['user_id']
    ...
    if(!$userData && !$taskData){
        ...
        require_once "../views/task_update.php";      
        //se declara un objeto de la clase Task()
        }
    exit;
    }