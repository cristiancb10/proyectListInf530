<?php
//para visualizar lo errores de la ejecucion para ello cambiar a 1
...
//En caso de ser asi se crea una variable que almacena el valor de $_Get['user_id']
...
//se crea un objeto de la clase Task()
    $task = new Task();
//se crea una variable $today_task que almacena el resultado del metodo today_Task()
//enviando el valor de $user_id
//siendo en este caso un array asociativo     
    $today_tasks = $task->todayTasks($user_id);
//se ejecuta la view de task_today.php
    include '../views/task_today.php';
} else {
